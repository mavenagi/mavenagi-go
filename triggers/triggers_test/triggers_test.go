...
func TestTriggersSearchWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/v1/triggers")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"triggers": []interface{}{map[string]interface{}{"triggerId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "enabled": true, "description": "description", "type": "CONVERSATION_CREATED"}, map[string]interface{}{"triggerId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "enabled": true, "description": "description", "type": "CONVERSATION_CREATED"}}, "number": 1, "size": 1, "totalElements": 1000000, "totalPages": 1},
...
func TestTriggersCreateOrUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/v1/triggers")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"triggerId": map[string]interface{}{"referenceId": "store-in-snowflake", "appId": "snowflake", "organizationId": "acme", "agentId": "support", "type": "EVENT_TRIGGER"}, "description": "Stores conversation data in Snowflake", "type": "CONVERSATION_CREATED", "enabled": true},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestTriggersGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/v1/triggers/{triggerReferenceId}")).WithPathParam(
		"triggerReferenceId",
		gowiremock.Matching("store-in-snowflake"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"triggerId": map[string]interface{}{"referenceId": "store-in-snowflake", "appId": "snowflake", "organizationId": "acme", "agentId": "support", "type": "EVENT_TRIGGER"}, "description": "Stores conversation data in Snowflake", "type": "CONVERSATION_CREATED", "enabled": true},
		).WithStatus(http.StatusOK),
...
func TestTriggersDeleteWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Delete(gowiremock.URLPathTemplate("/v1/triggers/{triggerReferenceId}")).WithPathParam(
		"triggerReferenceId",
		gowiremock.Matching("store-in-snowflake"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
...
func TestTriggersPartialUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/v1/triggers/{triggerReferenceId}")).WithPathParam(
		"triggerReferenceId",
		gowiremock.Matching("triggerReferenceId"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"triggerId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "enabled": true, "description": "description", "type": "CONVERSATION_CREATED"},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
