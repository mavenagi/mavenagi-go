...
func TestSegmentsSearchWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/v1/segments")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"segments": []interface{}{map[string]interface{}{"segmentId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "status": "ACTIVE", "name": "name", "precondition": map[string]interface{}{"preconditionType": "user", "key": "key", "value": "value", "operator": "NOT"}}, map[string]interface{}{"segmentId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "status": "ACTIVE", "name": "name", "precondition": map[string]interface{}{"preconditionType": "user", "key": "key", "value": "value", "operator": "NOT"}}}, "number": 1, "size": 1, "totalElements": 1000000, "totalPages": 1},
...
func TestSegmentsCreateOrUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Put(gowiremock.URLPathTemplate("/v1/segments")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"segmentId": map[string]interface{}{"referenceId": "admin-users", "appId": "auth-app", "organizationId": "acme", "agentId": "support", "type": "SEGMENT"}, "name": "Admin users", "status": "ACTIVE", "precondition": map[string]interface{}{"preconditionType": "group", "operator": "AND", "preconditions": []interface{}{map[string]interface{}{"preconditionType": "user", "key": "userKey"}, map[string]interface{}{"preconditionType": "user", "key": "userKey2"}}}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestSegmentsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/v1/segments/{segmentReferenceId}")).WithPathParam(
		"segmentReferenceId",
		gowiremock.Matching("admin-users"),
	).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"segmentId": map[string]interface{}{"referenceId": "admin-users", "appId": "auth-app", "organizationId": "acme", "agentId": "support", "type": "SEGMENT"}, "name": "Admin users", "status": "ACTIVE", "precondition": map[string]interface{}{"preconditionType": "group", "operator": "AND", "preconditions": []interface{}{map[string]interface{}{"preconditionType": "user", "key": "userKey"}, map[string]interface{}{"preconditionType": "user", "key": "userKey2"}}}},
		).WithStatus(http.StatusOK),
...
func TestSegmentsPatchWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/v1/segments/{segmentReferenceId}")).WithPathParam(
		"segmentReferenceId",
		gowiremock.Matching("segmentReferenceId"),
	).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"segmentId": map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "type": "AGENT", "appId": "appId", "referenceId": "referenceId"}, "status": "ACTIVE", "name": "name", "precondition": map[string]interface{}{"preconditionType": "user", "key": "key", "value": "value", "operator": "NOT"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
