...
func (r *RawClient) Search(
...
) (*core.Response[*mavenagigo.ActionsResponse], error) {
	...
	endpointURL := baseURL + "/v1/actions/search"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	var response *mavenagigo.ActionsResponse
	...
	return &core.Response[*mavenagigo.ActionsResponse]{
...
func (r *RawClient) CreateOrUpdate(
	...
	endpointURL := baseURL + "/v1/actions"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	var response *mavenagigo.ActionResponse
	raw, err := r.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
	...
	return &core.Response[*mavenagigo.ActionResponse]{
		StatusCode: raw.StatusCode,
		Header:     raw.Header,
		Body:       response,
	}, nil
