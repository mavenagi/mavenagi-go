...
func (r *RawClient) SessionToken(
...
) (*core.Response[*mavenagigo.VoiceSessionTokenResponse], error) {
	...
	endpointURL := baseURL + "/v1/voice/session-token"
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
		options.ToHeader(),
	)
	var response *mavenagigo.VoiceSessionTokenResponse
	...
	return &core.Response[*mavenagigo.VoiceSessionTokenResponse]{
