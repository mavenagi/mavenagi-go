...
func (r *RawClient) RollbackKnowledgeBaseVersion(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/knowledge/%v/rollback",
		knowledgeBaseReferenceID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
...
func (r *RawClient) UpdateKnowledgeBaseVersionProgress(
	ctx context.Context,
	...
	endpointURL := internal.EncodeURL(
		baseURL+"/v1/knowledge/%v/version/progress",
		knowledgeBaseReferenceID,
	)
	headers := internal.MergeHeaders(
		r.options.ToHeader(),
