...
func TestAssetsInitiateUploadWithWireMock(
	...
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/v1/assets")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"assetId": map[string]interface{}{"referenceId": "referenceId"}, "uploadUrl": "uploadUrl", "expiresAt": "2024-01-15T09:30:00Z"},
...
func TestAssetsCommitUploadWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Post(gowiremock.URLPathTemplate("/v1/assets/{assetReferenceId}/commit")).WithPathParam(
		"assetReferenceId",
		gowiremock.Matching("assetReferenceId"),
