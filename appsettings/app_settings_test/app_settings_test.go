...
func TestAppSettingsSearchWithWireMock(
	...
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/v1/app-settings/search")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"results": []interface{}{map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "settings": map[string]interface{}{"settings": map[string]interface{}{"key": "value"}}}, map[string]interface{}{"organizationId": "organizationId", "agentId": "agentId", "settings": map[string]interface{}{"settings": map[string]interface{}{"key": "value"}}}}},
...
func TestAppSettingsGetWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Get(gowiremock.URLPathTemplate("/v1/app-settings")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"string": map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
	err := WireMockClient.StubFor(stub)
	require.NoError(t, err, "Failed to create WireMock stub")
...
func TestAppSettingsUpdateWithWireMock(
	...
	// wiremock client and server initialized in shared main_test.go
	defer WireMockClient.Reset()
	stub := gowiremock.Patch(gowiremock.URLPathTemplate("/v1/app-settings")).WithBodyPattern(gowiremock.MatchesJsonSchema("{}", "V202012")).WillReturnResponse(
		gowiremock.NewResponse().WithJSONBody(
			map[string]interface{}{"string": map[string]interface{}{"key": "value"}},
		).WithStatus(http.StatusOK),
	)
